...
从课标抽出 1,339 条候选能力锚点，**只有 146 条**通过了「判定客观、无需教师复核」的门槛并随包分发：
...
这 146 条集中在**语文识字/写字/背诵**与**英语词汇**——因为这些能力的对错是客观的：字写对没有、篇背下来没有。
...
**3. 只能引用可用锚点。**
断言指向一条没人复核过的锚点，等于用没验过的尺子量孩子。传了不在这 146 条里的 ID 会直接报错。
